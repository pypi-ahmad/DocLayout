...
from doclayout.processors.llm import BaseLLMComplexBlockProcessor
from doclayout.schema import BlockTypes
from doclayout.schema.blocks import Block, Table, TableCell
...
class LLMTableProcessor(BaseLLMComplexBlockProcessor):
    ...
    table_rewriting_prompt: Annotated[
        ...
        "Default is a string containing the GPT-6 Sol rewriting prompt.",
